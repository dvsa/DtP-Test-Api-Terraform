module "ABC_usage_plan" {
  ...
  usage_plan_name       = "${var.ABC_usage_plan["organization_name"]}"
...
module "IMI_usage_plan" {
  ...
  count                 = "${var.mot_DtP_mock_api_enabled}"  
  environment           = "${var.environment}"
  usage_plan_name       = "${var.IMI_usage_plan["organization_name"]}"
...
module "CandG_usage_plan" {
  ...
  count                 = "${var.mot_DtP_mock_api_enabled}"  
  environment           = "${var.environment}"
  usage_plan_name       = "${var.CandG_usage_plan["organization_name"]}"
...
module "Kainos_usage_plan" {
  ...
  count                 = "${var.mot_DtP_mock_api_enabled}"  
  environment           = "${var.environment}"
  usage_plan_name       = "${var.Kainos_usage_plan["organization_name"]}"
